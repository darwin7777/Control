...
<body>
    ...
    <div class="paginacion">
        <?php
        if ($paginaActual > 1) {
            echo "<a href='consultaLO.php?user=$usu&nombre=$nombre&apellido=$apellido&rol=$rol&pagina=" . ($paginaActual - 1) . "'>Anterior</a>";
        }
        ...
        for ($i = 1; $i <= $totalPaginas; $i++) {
            if ($i == $paginaActual) {
                ...
                echo "<a href='consultaLO.php?user=$usu&nombre=$nombre&apellido=$apellido&rol=$rol&pagina=$i'>$i</a>";
            }
        }

        if ($paginaActual < $totalPaginas) {
            echo "<a href='consultaLO.php?user=$usu&nombre=$nombre&apellido=$apellido&rol=$rol&pagina=" . ($paginaActual + 1) . "'>Siguiente</a>";
        }
        ?>
    </div>
